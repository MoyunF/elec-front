...
$(function () {
   ...
   // echart_33();
    ...
    function elec_detail() {
        document.addEventListener('DOMContentLoaded', function() {
            const table = document.getElementById('elec_detail');
            ...
            table.addEventListener('wheel', function(event) {
              ...
              // Apply scale to the table
              table.style.transform = `scale(${scale})`;
              table.style.transformOrigin = '0 0';  // Ensure the zoom happens from the top-left corner
            });
          });
